      ...
      <form class="login-form">
        <div class="row">
          <div class="input-field col s12 center">
            <img src="<?php echo WWW_IMAGE_PATH; ?>login-logo.png" alt="" class="circle responsive-img valign profile-image-login">
            <p class="center login-form-text">CMS Admin</p>
          </div>
        </div>
        ...
        <div class="row">
          <div class="input-field col s12">
			  ...
			  <button class="btn waves-effect waves-light col s12" type="submit" name="action" value="login">Login
 			 </button>
          </div>
        </div>
		<div class="row">
